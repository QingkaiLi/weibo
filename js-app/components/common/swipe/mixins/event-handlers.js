...
var EventHandlers = {
  ...
  swipeMove: function (e) {
    ...
    this.setState({
      ...
      swipeLeft: swipeLeft,
      trackStyle: getTrackCSS(Object.assign({left: swipeLeft}, this.props, this.state))
    });
  ...
  swipeEnd: function (e) {
    ...
    if (touchObject.swipeLength > minSwipe) {
      ...
      this.setState({
        trackStyle: getTrackAnimateCSS(Object.assign({left: currentLeft}, this.props, this.state))
      });
    }
  },
